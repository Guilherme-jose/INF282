...
# Mapeamento explícito de Tags para evitar erros de ordenação por índice
...
# Listas de nós para categorização logística
...
mapa.save("mapa_rondonia_rede_saude_completa_legenda.html")
print("Sucesso! O mapa foi salvo como 'mapa_rondonia_rede_saude_completa_legenda.html'. Abra-o no seu navegador para avaliar a logística.")