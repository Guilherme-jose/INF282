...
# Salva o resultado
mapa.save("mapa_rondonia_psas_logistica_2_legenda.html")
print("Sucesso! O mapa foi salvo como 'mapa_rondonia_psas_logistica_2_legenda.html'. Abra-o no seu navegador.")